...
class ParseHTTPClient extends ParseClient {
  ...
  final _ParseHTTPClient _client;
...
class _ParseHTTPClient extends http.BaseClient {
  _ParseHTTPClient({
    ...
    SecurityContext? securityContext,
        ...
        _client = securityContext != null ? IOClient(HttpClient(context: securityContext)) : http.Client();
  ...
  Future<http.StreamedResponse> send(http.BaseRequest request) {
    ...
    if ((_sendSessionId == true) && (data.sessionId != null) && (request.headers[keyHeaderSessionToken] == null))
